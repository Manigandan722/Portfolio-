    ...
    <section className="relative h-screen bg-cover bg-top" style={{ backgroundImage: `url(${Mani})` }}>
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center h-full top-10">
        ...
        <div className="w-full md:w-1/2 p-8 text-center md:text-left">
          ...
          <div className="text-lg md:text-xl mb-6 leading-relaxed text-gray-300 drop-shadow-md">
            {/* Set min-height to prevent shaking */}
            <div >
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-end">
          <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden hover:shadow-2xl transform hover:scale-110 transition-transform duration-500">
