...
const About = () => {
  return (
    <section id="about-me" className="py-16 bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {/* Expertise Section */}
        <div className="mb-12">
          <h3 className="text-3xl font-semibold mb-6">My Expertise</h3>
        ...
        <div className="mb-12">
          <h3 className="text-3xl font-semibold mb-6">Why Work With Me?</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
